...
namespace SGHR.Domain.Validators.ConfigurationRules.Users
{
    public class UsuarioValidator 
    {
        public bool Validate(Usuario? usuario, out string errorMessage)
        {
            ...
            if (!ValidationHelper.MinLength(usuario.Nombre, 3, "Nombre", out errorMessage)) return false;
            ...
            if (!ValidationHelper.MinLength(usuario.Contraseña, 8, "La contraseña", out errorMessage)) return false;
